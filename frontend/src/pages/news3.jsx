        ...
        <div className="news-detail-wrapper">
          <div className="news-detail-main">
            <div className="news-detail-img-wrapper">
              <img src="/mill.jpg" alt="Sustainable Rice" className="news-detail-img" />
              <span className="news-detail-date">{t('news_articles.date')}</span>
            </div>

            <div className="news-detail-meta">
              <span><FaUser /> {t('news_articles.by')} {t('news_articles.author_aliha')}</span>
              <span><FaComment /> {comments.length} {comments.length !== 1 ? t('news_page.comments_count') : t('news_page.comment_single')}</span>
            </div>

            <h1 className="news-detail-title">{t('news_section.n3_title')}</h1>

            <div className="news-detail-content">
              <p>{t('news_articles.news3.p1')}</p>
              <p>{t('news_articles.news3.p2')}</p>
              <p>{t('news_articles.news3.p3')}</p>
            </div>
