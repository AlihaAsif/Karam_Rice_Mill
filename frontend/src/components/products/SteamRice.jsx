...
const images = ["/product2.png", "/product1-2.png"];
...
export default function SteamRice() {
      ...
      <section className="sella-section">
        ...
        <div className="sella-top">
          <div className="sella-image-side">
            <img src={mainImage} alt="Steam Rice" className="sella-main-img" />
          ...
          <div className="sella-content">
            <h1 className="sella-title">Steam Rice</h1>
            <p className="sella-desc">
              At <strong>Karam Rice Mills</strong>, our <strong>Steam Rice</strong> is produced
              using advanced steaming technology that locks in nutrients and enhances the grain's
              natural whiteness. Each batch is hygienically processed and expertly packaged to
        ...
        <div className="sella-tabs-wrapper">
          ...
          {activeTab === "description" && (
            <div className="sella-tab-content">
              <p>
                At <strong>Karam Rice Mills</strong>, our <strong>Steam Rice</strong> is a
                premium product known for its bright white colour, long extra-long grain, and
                perfectly fluffy texture after cooking. Processed under strict quality control
          ...
          {activeTab === "reviews" && (
            <div className="sella-tab-content">
              ...
              <div className="review-form">
                <h3>Be the first to review "Steam Rice"</h3>
