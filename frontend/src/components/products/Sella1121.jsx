...
const images = ["/product1.png", "/product1-2.png"];

const relatedProducts = [
  { id: 1, name: "Steam Rice", image: "/product2.png", path: "/store/steam-rice" },
  { id: 2, name: "Golden Sella", image: "/product3.png", path: "/store/golden-sella" },
];

export default function Sella1121() {
      ...
      <section className="sella-section">
        ...
        <div className="sella-top">
          ...
          <div className="sella-image-side">
            <img src={mainImage} alt="1121 Sella" className="sella-main-img" />
          ...
          <div className="sella-content">
            <h1 className="sella-title">1121 Sella</h1>
            <p className="sella-desc">
              At <strong>Karam Rice Mills</strong>, we specialize in producing and supplying{" "}
              <strong>high-quality rice</strong> processed under strict quality control standards.
              Our rice is carefully sourced from trusted farms, hygienically milled, and expertly
              packaged to preserve its{" "}
              <strong>natural aroma, texture, and nutritional value</strong>.
            </p>
          ...
          {activeTab === "description" && (
            <div className="sella-tab-content">
              <p>
                ...
                <strong>high-quality rice</strong> processed under strict quality control standards.
                Our rice is carefully sourced from trusted farms, hygienically milled, and expertly
                packaged to preserve its <strong>natural aroma, texture, and nutritional value</strong>.
              </p>
          ...
          {activeTab === "reviews" && (
            <div className="sella-tab-content">
              ...
              <div className="review-form">
                <h3>Be the first to review "1121 Sella"</h3>
